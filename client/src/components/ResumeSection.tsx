  ...
  return (
    <section className="resume-section" aria-labelledby="resume-title">
      ...
      <div className="resume-actions">
        <a className="resume-download" href="https://files.manuscdn.com/user_upload_by_module/session_file/310419663030582146/FtFFYCiJPttkvHXM.pdf" target="_blank" rel="noreferrer"><Download size={19} aria-hidden="true" /> Download résumé <span>PDF · 2026</span></a>
        <a className="resume-linkedin" href="https://www.linkedin.com/in/navnotexist/" target="_blank" rel="noreferrer">View LinkedIn profile <ExternalLink size={15} aria-hidden="true" /></a>
      </div>
    </section>
  );
}
