...
export const caseStudies: Record<string, CaseStudy> = {
  "mental-roberta": {
    ...
    method: "The research system uses transformer and statistical methods for early screening. This case study frames the work through screening conditions, model behavior, and evaluation without exposing private implementation detail.",
  ...
  "dense-distillation": {
    ...
    method: "The reproduction uses dual ResNet-50 networks, dense-affinity distillation, CAM-guided semantic-refinement gating, and a multi-objective optimization pipeline. The focus is on implementation fidelity and the practical conditions of reproducing the framework.",
  ...
  "region-infinity": {
    ...
    method: "The work covers co-designed architecture and optimization, end-to-end ML pipelines, quantization and distillation techniques, distributed-training efficiency, and low-latency inference paths.",
    evidence: "The portfolio keeps this record at the responsibility level and does not expose private product details, proprietary implementation, customer information, or unverified latency and deployment metrics.",
