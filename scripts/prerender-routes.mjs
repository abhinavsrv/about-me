...
const routeMetadata = {
  ...
  directions: ["Research Directions — Abhinav Srivastava", "A source-profile-backed map of Abhinav Srivastava's research directions across foundation models, alignment, reliable intelligence, and scalable decision systems."],
